import BtnLogoutGr from './BtnLogoutGr';
import BtnLoginGr from './BtnLoginGr';
...
export default function Header() {
  ...
  const user = useSelector(state => state.taskReducer.userLog);

  return (
    <div className='fixed top-0 left-0 w-full z-10'>
      <Popover className="relative bg-slate-100 z-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="flex justify-between items-center border-b-2 border-gray-100 py-6 md:justify-start md:space-x-10">
                ...
                <>
                  <Popover.Button
                    className={classNames(
                      ...
                      'group bg-slate-100 rounded-md inline-flex items-center text-base font-medium hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500'
                    )}
                  >
                    <span>Solutions</span>
                    <ChevronDownIcon
          ...
          <div className="hidden md:flex items-center justify-end md:flex-1 lg:w-0">
            ...
            {/* {Uslocaler ? <BtnLoginGr name={localUser.taiKhoan}/> : <BtnLogoutGr/>} */}
            {user ? <BtnLoginGr data={user}/> : <BtnLogoutGr/>}
